  ...
  return (
    <AnimatePresence mode="wait">
      <motion.h1
        ...
        className={`uppercase font-mono text-white text-2xl sm:text-3xl lg:text-4xl tracking-[0.15em] whitespace-nowrap ${className}`}
  ...
  return (
    ...
    >
      <style jsx>{`
        ...
        @keyframes neon-sign {
          0%   { opacity: 0.4; filter: drop-shadow(0 0 5px #00ffad); }
          10%  { opacity: 1; filter: drop-shadow(0 0 20px #00ffad) drop-shadow(0 0 40px #00ffad); }
          15%  { opacity: 0.3; filter: drop-shadow(0 0 5px #00ffad); }
          25%  { opacity: 1; filter: drop-shadow(0 0 25px #00ffad) drop-shadow(0 0 50px #00ffad); }
          30%  { opacity: 0.4; filter: drop-shadow(0 0 5px #00ffad); }
          40%  { opacity: 1; filter: drop-shadow(0 0 30px #00ffad) drop-shadow(0 0 60px #00ffad); }
          45%  { opacity: 0.5; filter: drop-shadow(0 0 10px #00ffad); }
          100% { opacity: 0.6; filter: drop-shadow(0 0 15px #00ffad) drop-shadow(0 0 30px #00ffad); }
        }
        .logo-stroke:hover {
          opacity: 0.8;
      ...
      <svg
        ...
        height="200"
        viewBox="0 0 600 200"
        className="mx-auto block select-none py-[-0px] py-[-0p2x] py-[-0px] py-[-0x] py-[-x] py-[-3x] py-[-3px] py-0 px-0 my-[30px] font-mono font-extrabold text-2xl"
        aria-hidden="true"
      >
        <text
          x="50%"
    ...
    >
      ...
      <div className="absolute inset-0 opacity-15">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="loaderGrid" width="50" height="50" patternUnits="userSpaceOnUse">
              <path d="M 50 0 L 0 0 0 50" fill="none" stroke="#00ff88" strokeWidth="0.8" />
            </pattern>
            <filter id="glow">
          ...
          <rect width="100%" height="100%" fill="url(#loaderGrid)" filter="url(#glow)" />
        </svg>
        ...
        >
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="animatedGrid" width="100" height="100" patternUnits="userSpaceOnUse">
                <path d="M 100 0 L 0 0 0 100" fill="none" stroke="#00ffad" strokeWidth="0.3" />
              </pattern>
            </defs>
...
export function Hero() {
  ...
  return (
    <>
      <AnimatePresence>{showLoader && <FuturisticLoader onComplete={() => setShowLoader(false)} />}</AnimatePresence>

      <motion.section
        className="min-h-[100vh] relative isolate flex flex-col items-center justify-center gap-8"
